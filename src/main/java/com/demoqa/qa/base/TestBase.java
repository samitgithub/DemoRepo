...
import com.demoqa.qa.utils.WebEventListener;
...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\Users\\sk00345470\\Desktop\\Selenium\\DemoQATest\\src\\main\\java\\com\\demoqa\\qa\\config\\config.properties");
			prop.load(ip);
	...
	public static void initialization() {
		...
		if (browsername.equals("chrome")) {
			...
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\sk00345470\\Desktop\\Selenium\\geckodriver.exe");
			driver = new ChromeDriver();
